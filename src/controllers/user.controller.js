...
const generateAccessAndRefreshToken = async (userId) => {
   try {
      ...
      throw new ApiError(500, " something went wrong while gnreating refresh and access token")
   }
}
...
const regiserUser = asyncHandler(async (req, res) => {
   ...
   // check if user is alrady exists:user name ,email
   // check for images ,check for avatar
   // upload them to cloudinary, avatar
   //create user object -create entry in db 
   //remove password and refresh token faild from resposne
...
const loginUser = asyncHandler(async (req, res) => {
   ...
   // console.log(password + "is passwordvalid " + isPasswordValid)
   if (!isPasswordValid) {
...
const updateAccountDetails = asyncHandler(async (req, res) => {
   ...
   return res
      .status(200)
      .json(new ApiResponse(200, user, "account details update succusfully "))
})
   ...
   return res
      ...
      .json(
         new ApiResponse(
            ...
            "wathch history fetched successfuly "
         )
      )
})
...
export { regiserUser, loginUser, logoutUser, refreshAccessToken, changeCurrentPassword, getCurrentUser, updateAccountDetails, updateUserAvatar, updateUserCoverImage, getUserChannelProfile, getWatchHistory }